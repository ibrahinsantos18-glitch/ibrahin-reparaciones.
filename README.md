...
<head>
  ...
  <title>Ibrahin Reparaciones | Servicio técnico de celulares en RD</title>
  <meta name="description" content="Técnico experto en reparación de celulares: pantallas, baterías, puertos de carga, software y más. Servicio rápido y garantizado en República Dominicana." />
  <meta name="theme-color" content="#0ea5e9" />
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
  <!-- Favicon con el nuevo logo SVG -->
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <rect rx="14" ry="14" x="6" y="6" width="52" height="52" fill="url(#g)"/>
    <rect x="20" y="14" width="24" height="36" rx="4" ry="4" fill="#001018" opacity=".2"/>
  ...
  <style>
    :root{
      ...
      --ring: 0 0 0 6px rgba(14,165,233,.15);
    }
    *{box-sizing:border-box}
    html,body{margin:0;height:100%;background:radial-gradient(1200px 600px at 75% -10%,rgba(34,211,238,.15),transparent),radial-gradient(1000px 600px at -10% 10%,rgba(14,165,233,.18),transparent),var(--bg);color:var(--text);font-family:'Outfit',system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif;}
    a{color:inherit;text-decoration:none}
    img{max-width:100%;display:block}
    .container{max-width:1200px;margin:0 auto;padding:0 20px}
    .btn{display:inline-flex;gap:.6rem;align-items:center;justify-content:center;padding:.9rem 1.2rem;border-radius:16px;background:linear-gradient(135deg,var(--primary),var(--primary-2));color:#001018;font-weight:700;box-shadow:0 10px 30px rgba(34,211,238,.25);transition:transform .15s ease, box-shadow .15s ease}
    .btn:hover{transform:translateY(-1px);box-shadow:0 12px 40px rgba(34,211,238,.35)}
    .btn.outline{background:transparent;border:1px solid rgba(148,163,184,.3);color:var(--text)}
    .badge{display:inline-flex;align-items:center;gap:.5rem;padding:.35rem .6rem;border:1px solid rgba(148,163,184,.3);border-radius:999px;color:var(--muted);backdrop-filter:blur(6px)}
    ...
    header{position:sticky;top:0;background:rgba(11,18,32,.6);backdrop-filter:blur(10px);border-bottom:1px solid rgba(148,163,184,.15);z-index:40}
...
<body>
  <!-- WhatsApp Button -->
  <a class="wa" href="https://wa.me/18097615182?text=Hola%20Ibrahin,%20necesito%20ayuda%20con%20mi%20celular" aria-label="Hablar por WhatsApp" target="_blank" rel="noopener">
    ...
    <section id="contacto">
      ...
      <div class="container" style="margin-top:18px">
        <div class="card">
          ...
          <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:16px;border:1px solid rgba(148,163,184,.15)">
